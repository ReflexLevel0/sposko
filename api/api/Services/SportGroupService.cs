...
public class SportGroupService(ISposkoDb db, IServiceHelper<SportGroup, SportGroupDTO, CreateSportGroupDTO, CreateSportGroupDTO> serviceHelper) : ISportGroupService
{
